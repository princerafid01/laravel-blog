	  ...
	  <div id="login-page">
	  	<div class="container">
		     ...
		     <!-- <form class="form-login" action="index.html"> -->
		     	{!! Form::open(['url' => 'admin-login-check', 'class' => 'form-login']) !!}
		        ...
		        <div class="login-wrap">
		        	...
		        	<input type="text" name="email" placeholder="Email" autocomplete="off" class="form-control placeholder-no-fix" autofocus>
