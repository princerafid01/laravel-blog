  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="{{ URL::to('/dashboard') }}" class="logo"><b>DASHGUM FREE</b></a>
            <!--logo end-->
                ...
                <ul class="nav top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#">
                            ...
                            <span class="badge bg-theme">{{ $comments }}</span>
                        </a>
                        <ul class="dropdown-menu extended tasks-bar">
                            <div class="notify-arrow notify-arrow-green"></div>
                            <li>
                                <p class="green">You have {{ $comments }} pending comments</p>
                            </li>
                            <li>
                            <li class="external">
                                <a href="{{ URL::to('/manage-comments') }}">See All Tasks</a>
                            </li>
                        </ul>
                    </li>
                    <!-- settings end -->
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="{{URL::to('/admin-logout')}}">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered"><?php echo Session::get('admin_name'); ?></h5>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="{{URL::to('/manage-blog')}}">Manage blog</a></li>
                          <li><a  href="{{URL::to('/manage-comments')}}">Manage Comments</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
